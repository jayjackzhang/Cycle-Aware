    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        with dt[2]:
            preds = non_max_suppression(
                preds,train_out, conf_thres, iou_thres, labels=lb, multi_label=True, agnostic=single_cls, max_det=max_det, cosface_weight = compute_loss.cosface_weight,bn_embed = compute_loss.bn_embed
            )
